...
class PickingPointStrategy(BaseLabelingStrategy):
    ...
    def draw_preview(self) -> None: 
        ...
        if not self.tmp_p1 == None :
            ...
            if idx:
                ogl.draw_points([self.view.controller.pcd_manager.pointcloud.points[idx[0]]], color=self.preview_color, point_size=int(config.getfloat("POINTCLOUD", "POINT_SIZE"))*2)
